...
<body class="flex flex-col leading-relaxed tracking-wide gradient">
    ...
    <section class="py-8 bg-white border-p">
        <div class="container flex flex-wrap pt-4 pb-12 mx-auto">
            <h2 class="w-full my-2 text-5xl font-black leading-tight text-center text-gray-800">
            ...
            <div class="flex flex-col flex-grow flex-shrink w-full p-6 rounded-lg md:w-1/3">
                <div class="flex-1 overflow-hidden bg-white">
                    <div class="p-5 bg-red-100 border-b-4 border-red-600 rounded-lg shadow-lg">
                        <div class="flex flex-row items-center">
                            <div class="flex-1 text-center">
                                <h5 class="font-bold text-gray-600 uppercase">Positive/<i>Positif</i></h5>
                                <h3 class="text-3xl font-bold">{{ $province->positif }}<span class="text-red-500"><i class="fas fa-caret-up"></i></span></h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col flex-grow flex-shrink w-full p-6 rounded-lg md:w-1/3">
                <div class="flex-1 overflow-hidden bg-white">
                    <div class="p-5 bg-green-100 border-b-4 border-green-600 rounded-lg shadow-lg">
                        <div class="flex flex-row items-center">
                            <div class="flex-1 text-center">
                                <h5 class="font-bold text-gray-600 uppercase">Recovered/<i>Sembuh</i></h5>
                                <h3 class="text-3xl font-bold">{{ $province->sembuh }}<span class="text-green-500"><i class="fas fa-caret-up"></i></span></h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col flex-grow flex-shrink w-full p-6 rounded-lg md:w-1/3">
                <div class="flex-1 overflow-hidden bg-white">
                    <div class="p-5 bg-yellow-100 border-b-4 border-yellow-600 rounded-lg shadow-lg">
                        <div class="flex flex-row items-center">
                            <div class="flex-1 text-center">
                                <h5 class="font-bold text-gray-600 uppercase">Death/<i>Meninggal</i></h5>
                                <h3 class="text-3xl font-bold">{{ $province->meninggal }}<span class="text-yellow-500"><i class="fas fa-caret-up"></i></span></h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full p-3 md:w-1/3">
                ...
                <div class="bg-white border-transparent rounded-lg shadow-lg">
                    <div class="p-2 text-gray-800 uppercase bg-gray-300 border-b-2 border-gray-500 rounded-tl-lg rounded-tr-lg">
                        <h5 class="font-bold text-gray-600 uppercase">Positive/<i>Positif</i></h5>
                    </div>
                    <div class="p-5">
            ...
            <div class="w-full p-3">
                ...
                <div class="bg-white border-transparent rounded-lg shadow-lg">
                    <div class="p-2 text-gray-800 uppercase bg-gray-300 border-b-2 border-gray-500 rounded-tl-lg rounded-tr-lg">
                        <h5 class="font-bold text-gray-600 uppercase">Comparisson/<i>Perbandingan</i></h5>
                    </div>
            ...
            <div class="w-full p-3">
                ...
                <div class="bg-white border-transparent rounded-lg shadow-lg">
                    <div class="p-2 text-gray-800 uppercase bg-gray-300 border-b-2 border-gray-500 rounded-tl-lg rounded-tr-lg">
                        <h5 class="font-bold text-gray-600 uppercase">District/<i>Kabupaten</i></h5>
                    </div>
                    <div class="p-5">
                        <table id="table_district" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                            <thead>
                                <tr>
                                    <th data-priority="1" class="text-left text-blue-900 w-1/11">Name</th>
                                    <th data-priority="2" class="text-left text-blue-900 w-1/11">Positive</th>
                                    <th data-priority="3" class="text-left text-blue-900 w-1/11">Negative</th>
                                    <th data-priority="4" class="text-left text-blue-900 w-1/11">Recovered</th>
                                    <th data-priority="5" class="text-left text-blue-900 w-1/11">Death</th>
                                    <th data-priority="6" class="text-left text-blue-900 w-1/11">ODP</th>
                                    <th data-priority="7" class="text-left text-blue-900 w-1/11">Finished ODP</th>
                                    <th data-priority="8" class="text-left text-blue-900 w-1/11">In ODP</th>
                                    <th data-priority="9" class="text-left text-blue-900 w-1/11">PDP</th>
                                    <th data-priority="10" class="text-left text-blue-900 w-1/11">Finished PDP</th>
                                    <th data-priority="11" class="text-left text-blue-900 w-1/11">In PDP</th>
                                </tr>
                            </thead>
                            <tbody>
