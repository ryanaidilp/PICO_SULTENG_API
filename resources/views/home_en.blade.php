    ...
    <body class="gradient leading-relaxed tracking-wide flex flex-col">
            ...
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-2 lg:py-6">
                ...
                <div class="flex w-1/2 justify-end content-center">
                    <a class="inline-block text-gray-300 no-underline hover:text-gray-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4"
                        href="https://github.com/RyanAidilPratama/PICO_SULTENG_API" target="_blank"
                        data-tippy-content="@github_handle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-current h-6" viewBox="0 0 32 32"
                            version="1.1">
                    ...
                    <a class="inline-block text-gray-300 no-underline hover:text-gray-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4"
                        data-tippy-content="@instagram_handle" target="_blank"
                        href="https://instagram.com/banuacoders_">
                        <svg id="icon-instagram" class="fill-current h-6" viewBox="0 0 32 32">
                    ...
                    <a class="inline-block text-gray-300 no-underline hover:text-gray-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4"
                        target="_blank" data-tippy-content="#facebook_id" href="https://www.facebook.com/banuacoders">
                    ...
                    <a class="inline-block text-gray-300 no-underline hover:text-gray-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4"
                        target="_blank" data-tippy-content="@youtube_handle"
                        href="https://www.youtube.com/channel/UC0SrBwl_lIlvR_wpYcmCG8w">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 fill-current" viewBox="0 0 32 32"
                            version="1.1">
        ...
        <div class="container mx-auto h-screen">
            ...
            <div class="flex items-center w-full mx-auto">
                <div class="flex flex-1 m-6 md:px-0 md:m-12 w-1/2">
                    <img src="{{ $path }}" />
                </div>
            </div>
        </div>
        ...
        <section class="bg-white border-b py-12 ">
            <div class="container mx-auto flex flex-wrap items-center justify-between pb-12">
                ...
                <div
                    class="flex flex-1 flex-wrap max-w-4xl mx-auto items-center justify-between text-gray-500 opacity-75">
                    <span class="w-1/2 p-4 md:w-auto flex items-center">
                        <img src="https://img.shields.io/github/license/RyanAidilPratama/PICO_SULTENG_API?color=blue"
                            alt="">
                    </span>

                    <span class="w-1/2 p-4 md:w-auto flex items-center">
                        <img src="https://img.shields.io/github/commit-activity/m/RyanAidilPratama/PICO_SULTENG_API" />
                    </span>
                    <span class="w-1/2 p-4 md:w-auto flex items-center">
                        <img src="https://img.shields.io/github/stars/RyanAidilPratama/PICO_SULTENG_API" alt="">
                    </span>
                    <span class="w-1/2 p-4 md:w-auto flex items-center">
                        <img src="https://img.shields.io/website?url=https%3A%2F%2Fbanuacoders.com%2Fapi%2Fpico" alt="">
                    </span>
                    <span class="w-1/2 p-4 md:w-auto flex items-center">
                        <img src="https://img.shields.io/github/last-commit/RyanAidilPratama/PICO_SULTENG_API" alt="">
                    </span>
                    <span class="w-1/2 p-4 md:w-auto flex items-center">
        ...
        <section class="bg-white border-b py-8">
            <div class="container mx-auto flex flex-wrap pt-4 pb-12">
                ...
                <div class="hover:shadow-2xl rounded-lg w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                ...
                <div class="hover:shadow-2xl rounded-lg w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white overflow-hidden">
                ...
                <div class="hover:shadow-2xl rounded-lg w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white overflow-hidden">
                        <a href="https://banuacoders.com/api/pico/posko"
                            class="flex flex-wrap no-underline hover:no-underline">
                            <p class="w-full text-gray-600 text-xs md:text-sm px-6 mt-6">
                                DATA
                            </p>
        ...
        <section class="bg-white border-p py-8">
            <div class="container mx-auto flex flex-wrap pt-4 pb-12">
                <h2 class="w-full my-2 text-5xl font-black leading-tight text-center text-gray-800">
                    COVID-19 Situation in Central Sulawesi
                </h2>
                <div class="w-full mb-4">
                    <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
                </div>
                <div class="w-full text-xl text-gray-800 px-6 my-4">
                    Last update : <span class="font-bold ">{{ $province->updated_at->format('l, d F Y H:m:s') }}</span>
                </div>
                        ...
                        <div class="bg-red-100 border-b-4 border-red-600 rounded-lg shadow-lg p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-1 text-center">
                                    <h5 class="font-bold uppercase text-gray-600">Positive/<i>Positif</i></h5>
                                    <h3 class="font-bold text-3xl">{{ $province->positif }}<span class="text-red-500"><i
                ...
                <div class="rounded-lg w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white overflow-hidden">
                        <div class="bg-green-100 border-b-4 border-green-600 rounded-lg shadow-lg p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-1 text-center">
                                    <h5 class="font-bold uppercase text-gray-600">Recovered/<i>Sembuh</i></h5>
                                    <h3 class="font-bold text-3xl">{{ $province->sembuh }}<span
                ...
                <div class="rounded-lg w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white overflow-hidden">
                        <div class="bg-yellow-100 border-b-4 border-yellow-600 rounded-lg shadow-lg p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-1 text-center">
                                    <h5 class="font-bold uppercase text-gray-600">Death/<i>Meninggal</i></h5>
                                    <h3 class="font-bold text-3xl">{{ $province->meninggal }}<span
                                            class="text-yellow-500"><i class="fas fa-caret-up"></i></span></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-white border-transparent rounded-lg shadow-lg">
                        <div
                            class="bg-gray-300 uppercase text-gray-800 border-b-2 border-gray-500 rounded-tl-lg rounded-tr-lg p-2">
                            <h5 class="font-bold uppercase text-gray-600">Comparisson/<i>Perbandingan</i></h5>
                        </div>
                        <div class="p-5"><canvas id="pie_chart" class="chartjs" width="undefined"
                                height="undefined"></canvas>
                            <script>
                                new Chart(document.getElementById("pie_chart"), {
                                    "type": "doughnut",
                                    "data": {
                                        "labels": ["Under Treatment (%)", "Death (%)", "Recovered (%)"],
                                        "datasets": [{
                                            "label": "Cases",
                                            "data":
                                                [
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-white border-transparent rounded-lg shadow-lg">
                        <div
                            class="bg-gray-300 uppercase text-gray-800 border-b-2 border-gray-500 rounded-tl-lg rounded-tr-lg p-2">
                            <h5 class="font-bold uppercase text-gray-600">District/<i>Kabupaten</i></h5>
                        </div>
                        <div class="p-5">
                            <table id="table_district" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                                <thead>
                                    <tr>
                                        <th data-priority="1" class="w-1/11 text-left text-blue-900">Name</th>
                                        <th data-priority="2" class="w-1/11 text-left text-blue-900">Positive</th>
                                        <th data-priority="3" class="w-1/11 text-left text-blue-900">Negative</th>
                                        <th data-priority="4" class="w-1/11 text-left text-blue-900">Recovered</th>
                                        <th data-priority="5" class="w-1/11 text-left text-blue-900">Death</th>
                                        <th data-priority="6" class="w-1/11 text-left text-blue-900">ODP</th>
                                        <th data-priority="7" class="w-1/11 text-left text-blue-900">Finished ODP</th>
                                        <th data-priority="8" class="w-1/11 text-left text-blue-900">In ODP</th>
                                        <th data-priority="9" class="w-1/11 text-left text-blue-900">PDP</th>
                                        <th data-priority="10" class="w-1/11 text-left text-blue-900">Finished PDP</th>
                                        <th data-priority="11" class="w-1/11 text-left text-blue-900">In PDP</th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        <section class="bg-white border-b py-8">
            <div class="container mx-auto flex flex-wrap pt-4 pb-12">
                ...
                <div class="hover:shadow-2xl rounded-lg w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white overflow-hidden">
                        <a href="https://dinkes.sultengprov.go.id/"
                            class="flex flex-wrap no-underline hover:no-underline">
                            <p class="w-full text-gray-600 text-xs md:text-sm px-6 mt-6">
                                WEBSITE
                            </p>
