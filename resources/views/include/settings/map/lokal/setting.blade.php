<script>
    ...
    var districtData = [
        @foreach($districts as $district)
            {"id":"{{ $district->kabupaten }}", "positif":{{ $district->positif }}, "sembuh" : {{ $district->sembuh }}, "meninggal": {{ $district->meninggal }},
    ...
    var districtPositiveDataset = anychart.data.set(districtData).mapAs({value: 'positif', size: 'positif'})
    var districtPositiveColor = ['#F9CACD','#F4A8AC','#EE868B','#E76569','#DF4346','#820029' ,'#6E002C', "#CD0000"]
    var districtRecoveredDataset = anychart.data.set(districtData).mapAs({value: 'sembuh', size: 'sembuh'})
    var districtRecoveredColor = ['#DEEDCF','#BFE1B0','#99D492','#74C67A','#56B870','#0E4D64' ,'#0A2F51','#1D9A6C']
    var districtDeathDataset = anychart.data.set(districtData).mapAs({value: 'meninggal', size: 'meninggal'})
    var districtDeathColor = ['#FFF3BA','#FFEB9B','#FFE07C','#FFD45D','#FFC63E','#E1851E' ,'#DA7F25','#FFA500']
    var districtODPDataset = anychart.data.set(districtData).mapAs({value: 'ODP', size: 'ODP'})
    var districtODPColor = ['#DFE4F8','#BECCF1','#9FB5E8','#80A2DF','#6190D5','#174689' ,'#0E2C63','#2773BF']
    var districtPDPDataset = anychart.data.set(districtData).mapAs({value: 'PDP', size: 'PDP'})
