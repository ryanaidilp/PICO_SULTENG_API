...
<nav id="header" class="w-full z-30 top-0 text-white py-1">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-2 lg:py-6">
        ...
        <div class="flex w-1/2 justify-end content-center">
            ...
            <a class="inline-block text-gray-300 no-underline hover:text-gray-800 hover:text-underline text-center h-10 pl-1 p-2 md:h-auto md:p-4 md:pl-1"
                href="{{ route('home') }}">
                <img src="https://cdn.webshopapp.com/shops/94414/files/54029380/indonesia-flag-icon-free-download.jpg" class="h-5 hover:shadow-md"
                title="Lihat versi Bahasa Indonesia">
            </a>
            @else
            <a class="inline-block text-gray-300 no-underline hover:text-gray-800 hover:text-underline text-center h-10 p-2 pr-1 md:h-auto md:p-4 md:pr-1"
            href="{{ route('home') }}?lang=en">
                <img src="https://cdn.webshopapp.com/shops/94414/files/54956666/the-united-kingdom-flag-icon-free-download.jpg" class="h-5 hover:shadow-md"
            ...
            <a class="inline-block text-gray-300 no-underline hover:text-gray-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="fill-current h-6" viewBox="0 0 32 32" version="1.1">
            ...
            <a class="inline-block text-gray-300 no-underline hover:text-gray-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4"
                data-tippy-content="@instagram_handle" target="_blank" href="https://instagram.com/banuacoders_">
